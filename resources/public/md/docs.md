...
Two middleware functions are provided by default in the `js-invaders2.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `js-invaders2.handler` namespace to manage the enabled middleware.
